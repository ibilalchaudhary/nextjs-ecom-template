...
export default () => {
  ...
  return (
    <Fragment>
      <div id="whatswidget-pre-wrapper" className="">
        <div
          ...
          <div
            ...
            <div
              ...
              <a
                ...
                target="_blank"
                href="https://web.whatsapp.com/send?phone=03036156978"
          ...
          {/*<div
            ...
            style={chatOpen ? { display: 'none' } : { all: 'revert' }}>
            <span
          ...
          <div className="whatswidget-button-wrapper" style={{ all: 'revert' }}>
            <div
      ...
      <style jsx id="whatswidget-style">
        {`
